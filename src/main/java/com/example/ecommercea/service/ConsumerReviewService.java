...
public class ConsumerReviewService {//소비자 리뷰
    ...
    public ConsumerReview createConsumerReview
            (ConsumerReviewRegister consumerReviewRegister){//소비자 리뷰 생성
        ...
        return consumerReviewRepository.save(ConsumerReviewRegister
                .consumerReviewForm(consumerReviewRegister));}
